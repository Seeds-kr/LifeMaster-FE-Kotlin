 ...
 * @property startTime 시작 시간 (HH:mm 형식)
 * @property endTime 종료 시간 (HH:mm 형식)
...
data class DetoxTimeLockResponse(
    ...
    val startMinutes: Int get() = startTime.split(":")[1].toInt()
    ...
    val endMinutes: Int get() = endTime.split(":")[1].toInt()
