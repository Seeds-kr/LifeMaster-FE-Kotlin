...
@AndroidEntryPoint
class AlarmEditFragment : Fragment(R.layout.fragment_alarm_setting) {
    ...
    private val args: AlarmEditFragmentArgs by navArgs()
    ...
    private fun initListeners() = with(binding) {
        ...
        btnSave.setOnClickListener {
            ...
            alarmGenerateViewModel.updateAlarm(alarmId = args.alarmId, request = AlarmRequest(
    ...
    private fun fetchData() {
        alarmGenerateViewModel.fetchAlarm(alarmId = args.alarmId)
    }
    ...
    private fun initObservers() = with(binding) {
        viewLifecycleOwner.lifecycleScope.launch {
            viewLifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                launch {
                    alarmGenerateViewModel.selectedAlarm.collect { resource ->
                        when(resource) {
                            ...
                            is DataResource.Success -> {
                                ...
                                cvAlarmRepeatDayMon.isSelected = alarm.alarmMon
                                cvAlarmRepeatDayTue.isSelected = alarm.alarmTue
                                cvAlarmRepeatDayWed.isSelected = alarm.alarmWed
                                cvAlarmRepeatDayThu.isSelected = alarm.alarmThu
                                cvAlarmRepeatDayFri.isSelected = alarm.alarmFri
                                cvAlarmRepeatDaySat.isSelected = alarm.alarmSat
                                cvAlarmRepeatDaySun.isSelected = alarm.alarmSun
